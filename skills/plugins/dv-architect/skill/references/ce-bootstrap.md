...
> Ported into DVerse v2 from the archived seed `d365-architect` skill.
> Publisher prefix examples below use `dv`, this repo's actual prefix
> (mechanically enforced by G2), not the seed's `dexx` placeholder. See
> `../SKILL.md`, "v2 reality".
...
| Prefix | dv | 2–8 lowercase letters; used for ALL custom schema names |
...
#    → Primary Entity: dv_mytable (logical name)

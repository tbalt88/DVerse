...
> Ported into DVerse v2 from the archived seed `d365-architect` skill. Record
> and field examples below use the `dv_` schema prefix, this repo's actual
...
{
    Target = new EntityReference("dv_order", orderId),
